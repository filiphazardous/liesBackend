 ...
 * @endcode
 */
$settings['hash_salt'] = 'V1VjPQLsOdvQHhriadb6zjdsCwZnM4PlI3ikuenKo4MSpD3L9p_Ge-pvIa3ls-Hp_whxIVl5Vg';
...
# }
$databases['default']['default'] = array (
  'database' => getenv('LIES_DB'),
  'username' => getenv('LIES_USER'),
  'password' => getenv('LIES_PASS'),
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
...
$config_directories['sync'] = 'sites/default/files/config_kqPZl93BC1GwxjZWk0d_uID1guLhzQcAsZlCEx-djcUqAaDF8z4jlqv3DAKz4cavQW8awdXeuw/sync';
